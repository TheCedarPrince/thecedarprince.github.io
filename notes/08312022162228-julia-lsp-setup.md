@def title = "Setting Up Julia LSP for Neovim"
@def slug = "08312022162228-julia-lsp-setup"
@def tags = ["summary", "neovim", "julia", "programming", "archive"]
@def description = "An explanation of how to setup the Julia LSP for Neovim"

@def rss_title = "Setting Up Julia LSP for Neovim"
@def rss_description = "An explanation of how to setup the Julia LSP for Neovim"
@def rss_pubdate = Date(2022, 8, 31)
